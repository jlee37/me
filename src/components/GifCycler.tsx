...
const GIFS: { url: string; lengthMs: number }[] = [
  ...
  // // Dark magician
  // {
  //   url: "https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExcmVuenc2ZzNiMTJnZnQ0N2ZidnBsenUzcHp6ZWt1YTUzaWN1NzZsdSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/55omzn8jo9Qld5L032/giphy.gif",
  //   lengthMs: 2000,
  // },
  // Exodia left arm
  {
